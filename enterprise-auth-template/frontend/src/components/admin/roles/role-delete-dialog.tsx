        ...
        <div className='py-4'>
          ...
          <div className='space-y-3'>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Important:</strong> If users only have this role, they will lose all
                permissions and may not be able to access the system. Make sure affected users have
                alternative roles assigned.
              </AlertDescription>
            </Alert>
          </div>
        </div>
