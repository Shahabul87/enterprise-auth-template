...
describe('Dashboard Page', () => {
  ...
  describe('User States', () => {
    ...
    it('should display unverified account warning', () => {
    ...
    it('should display inactive account warning', () => {
      const inactiveUser = {
        ...mockUser,
        is_active: false,
      };
    ...
    it('should display admin privileges for superuser', () => {
      const adminUser = {
        ...mockUser,
        is_superuser: true,
        roles: [
  ...
  describe('Interactions', () => {
    it('should navigate to profile page when edit profile is clicked', () => {
      render(<Dashboard />);
    ...
    it('should navigate to settings page when settings is clicked', () => {
      render(<Dashboard />);
  ...
  describe('User Metadata', () => {
    it('should display custom user metadata', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should display error state when user data fails to load', () => {
      mockUseAuth.mockReturnValue({
        ...defaultAuthContext,
        user: null,
        isLoading: false,
