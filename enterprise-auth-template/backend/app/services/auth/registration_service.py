...
class RegistrationService:
    ...
    async def register_user(
        ...
        try:
            ...
            await self._send_verification_email(
                created_user.email, created_user.full_name, verification_token
            )
    ...
    async def _create_user_entity(self, registration_data: RegisterRequest) -> User:
        ...
        full_name = (
            ...
            if hasattr(registration_data, "full_name") and registration_data.full_name
            else None
        )
    ...
    async def _assign_default_role(self, user_id: str) -> None:
        ...
        if default_role:
            ...
            logger.debug("Default role assigned", user_id=user_id, role="user")
