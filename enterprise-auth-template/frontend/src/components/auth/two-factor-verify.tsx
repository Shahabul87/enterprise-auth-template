  ...
  return (
    <Card className='w-full max-w-md'>
      <CardHeader>
        ...
        <CardDescription>Enter your verification code to complete sign in</CardDescription>
      </CardHeader>
        ...
        <Tabs value={method} onValueChange={(v) => setMethod(v as 'totp' | 'backup')}>
          ...
          <TabsContent value='backup' className='space-y-4'>
            ...
            <Alert>
              <AlertCircle className='h-4 w-4' />
              <AlertDescription>
                Each backup code can only be used once. After using a backup code, you should
