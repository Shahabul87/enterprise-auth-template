...
export function getStrengthBarColor(strength: PasswordStrengthResult['strength']): string {
  switch (strength) {
    case 'very-weak':
      return 'bg-red-600';
    case 'weak':
...
export function getStrengthLabel(strength: PasswordStrengthResult['strength']): string {
  switch (strength) {
    case 'very-weak':
      return 'Very Weak';
    case 'weak':
