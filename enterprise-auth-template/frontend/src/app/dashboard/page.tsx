    ...
    <div className='min-h-screen bg-muted/50'>
      ...
      <main className='container mx-auto px-4 py-8'>
          ...
          <Card>
            ...
            <CardContent className='space-y-2'>
              ...
              <div>
                ...
                <span
                  className={`ml-2 text-sm ${user.is_active ? 'text-green-600' : 'text-red-600'}`}
                >
              ...
              <div>
                ...
                <span
                  className={`ml-2 text-sm ${user.is_superuser ? 'text-blue-600' : 'text-gray-600'}`}
                >
              ...
              {permissions.length > 0 ? (
                <div className='space-y-1'>
                  {permissions.slice(0, 5).map((permission) => (
                    <div key={permission} className='text-sm p-2 bg-muted rounded-md'>
                      {permission}
                    </div>
                  ))}
                ...
                <div>
                  ...
                  <div className='space-y-1'>
                    <div className='text-sm'>
                      ...
                      <span
                        className={`ml-2 ${hasPermission('users:read') ? 'text-green-600' : 'text-red-600'}`}
                      >
                    ...
                    <div className='text-sm'>
                      ...
                      <span
                        className={`ml-2 ${hasPermission('users:write') ? 'text-green-600' : 'text-red-600'}`}
                      >
                    ...
                    <div className='text-sm'>
                      ...
                      <span
                        className={`ml-2 ${hasPermission('admin:*') ? 'text-green-600' : 'text-red-600'}`}
                      >
                ...
                <div>
                  ...
                  <div className='space-y-1'>
                    <div className='text-sm'>
                      <span className='font-medium'>admin:</span>
                      <span
                        className={`ml-2 ${hasRole('admin') ? 'text-green-600' : 'text-red-600'}`}
                      >
                    ...
                    <div className='text-sm'>
                      ...
                      <span
                        className={`ml-2 ${hasRole('user') ? 'text-green-600' : 'text-red-600'}`}
                      >
                    ...
                    <div className='text-sm'>
                      ...
                      <span
                        className={`ml-2 ${hasRole('moderator') ? 'text-green-600' : 'text-red-600'}`}
                      >
        ...
        <div className='mt-8'>
          <Alert>
            <AlertDescription>
              <strong>System Status:</strong> All systems operational. Your authentication session
