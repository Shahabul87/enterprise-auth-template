...
async def delete_user(
    ...
    return {"message": f"User {'permanently' if hard_delete else 'soft'} deleted successfully"}
...
async def terminate_all_sessions(
    ...
    await audit_service.log_activity(
        ...
        resource_type="user",
        resource_id=user_id,
        details={"terminated_by": current_user.id, "sessions_terminated": result["terminated_count"]}
    )
