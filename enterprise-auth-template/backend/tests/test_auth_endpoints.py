...
class TestLoginEndpoint:
    ...
    def test_login_locked_account(self, client: TestClient) -> None:
...
class TestTokenRefreshEndpoint:
    ...
    def test_successful_token_refresh(self, client: TestClient) -> None:
    ...
    def test_invalid_refresh_token(self, client: TestClient) -> None:
...
class TestPasswordResetEndpoints:
    ...
    def test_forgot_password_request(self, client: TestClient) -> None:
        ...
        with patch("app.api.v1.auth.get_db_session"):
            with patch("app.api.v1.auth.AuthService") as MockAuthService:
                ...
                assert (
                    "If an account with that email exists" in response.json()["message"]
                )

    def test_reset_password_with_token(self, client: TestClient) -> None:
    ...
    def test_reset_password_invalid_token(self, client: TestClient) -> None:
        ...
        reset_data = {"token": "invalid-token", "new_password": "NewSecurePassword123!"}
...
class TestEmailVerificationEndpoints:
    ...
    def test_verify_email(self, client: TestClient) -> None:
        ...
        with patch("app.api.v1.auth.get_db_session"):
            with patch("app.api.v1.auth.AuthService") as MockAuthService:
                ...
                response = client.get("/api/v1/auth/verify-email/valid-token")

                assert response.status_code == status.HTTP_200_OK
                assert "Email verified successfully" in response.json()["message"]

    def test_resend_verification(self, client: TestClient) -> None:
