...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, firstName: $firstName, lastName: $lastName, phoneNumber: $phoneNumber, bio: $bio, profilePicture: $profilePicture, profileImageUrl: $profileImageUrl, isEmailVerified: $isEmailVerified, isTwoFactorEnabled: $isTwoFactorEnabled, roles: $roles, permissions: $permissions, createdAt: $createdAt, updatedAt: $updatedAt, lastLoginAt: $lastLoginAt)';
  }
