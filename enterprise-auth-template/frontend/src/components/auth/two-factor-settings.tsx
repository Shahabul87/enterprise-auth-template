    ...
    return (
      <Card>
        <CardContent className='py-8'>
          <div className='text-center text-muted-foreground'>Loading 2FA settings...</div>
        </CardContent>
      </Card>
    );
  }
            ...
            <>
              <div className='space-y-3'>
                <div className='flex items-center justify-between p-3 border rounded-lg'>
                  ...
                  {status.methods.totp && <CheckCircle2 className='h-5 w-5 text-green-500' />}
                </div>
                ...
                {status.backup_codes_remaining < 3 && (
                  <Alert>
                    <AlertCircle className='h-4 w-4' />
                    <AlertDescription>
                      You have only {status.backup_codes_remaining} backup codes remaining. Consider
        ...
        <DialogContent>
          ...
          <div className='space-y-4'>
            <Alert variant='destructive'>
              <AlertCircle className='h-4 w-4' />
              <AlertDescription>
                Disabling 2FA will remove the extra security layer from your account. Your account
