...
jest.mock('@/hooks/use-error-handler', () => ({
  useFormErrorHandler: jest.fn(() => mockErrorHandler),
}));
...
jest.mock('@/hooks/use-auth-form', () => ({
  useAuthForm: jest.fn(() => mockAuthForm),
  validationRules: {
    email: {
...
describe('LoginForm', () => {
  ...
  describe('Loading States', () => {
    it('disables form elements when auth store is loading', () => {
    ...
    it('disables form elements when form is submitting', () => {
  ...
  describe('Component Integration', () => {
    it('integrates properly with auth store', () => {
      render(<LoginForm />);
    ...
    it('integrates properly with error handler', () => {
      render(<LoginForm />);
