...
class ErrorRecoveryStrategy:
    ...
    def get_recovery_plan(
        error_category: ErrorCategory, error_code: str
    ) -> Dict[str, Any]:
...
class ProgressTracker:
    ...
    STEPS = {
        "registration": [
            {
                "id": "validate_input",
                "name": "Validating your information",
                "duration": 0.5,
            },
            {
                "id": "check_availability",
                "name": "Checking email availability",
                "duration": 1.0,
            },
            {"id": "create_account", "name": "Creating your account", "duration": 1.5},
            {
                "id": "setup_security",
                "name": "Setting up security features",
                "duration": 1.0,
            },
            {
...
def create_detailed_error_response(
    ...
    can_retry, wait_time = retry_manager.should_retry(
        error_code, user_id or "anonymous"
    )
