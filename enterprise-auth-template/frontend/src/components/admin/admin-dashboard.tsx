      ...
      <CardContent className='space-y-4'>
        ...
        <div className='space-y-3'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-2'>
              <Badge className={getStatusColor(health.redis.status)}>{health.redis.status}</Badge>
              <span className='text-xs text-muted-foreground'>{health.redis.response_time}ms</span>
            </div>
          </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>System activity overview and top actions</CardDescription>
      </CardHeader>
      <CardContent className='space-y-4'>
